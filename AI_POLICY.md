...
- **No AI-generated media is allowed (images, audio, videos, etc.).** Text and code are the only acceptable AI-generated content, per the other rules in this policy.
